      ...
      <div className="flex flex-col xl:flex-row xl:space-x-4 py-12">
        <div className="xl:w-1/2">
          ...
          <p className="px-8 pt-8 text-white text-base sm:text-lg md:text-xl leading-relaxed">
            ...
            high-performance website? At Ombrio, we specialize in cutting-edge
            AI development and web solutions tailored to your needs. Whether
            you&apos;re a startup, enterprise, or entrepreneur, our team is
            ready to collaborate and bring your vision to life. Fill out the
            form below with your project details, and we&apos;ll get back to you
            with the next steps. Let&apos;s create something extraordinary
            together!
          </p>
