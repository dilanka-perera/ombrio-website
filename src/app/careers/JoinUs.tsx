        ...
        content={
          <>
            <p>
              ...
              helping transform industries with intelligent, scalable, and
              future-ready digital experiences.
            </p>
            <p className="my-5">
              We continuously push the boundaries of AI, machine learning, and
              custom web solutions to create impactful products that address
              real-world challenges. If you&apos;re passionate about innovation
              and eager to make a meaningful impact, we want you to be part of
              our team!
            </p>
            <MainButton
