        ...
        <div className="space-y-10">
          <section>
            ...
            <p className="text-lg">
              ...
              constantly growing and evolving, so please check back regularly
              for future opportunities. If you&apos;d like to stay updated on
              new openings, feel free to follow us on social media or reach out
              to us directly.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-lg mb-6">
              ...
              inclusive, and collaborative work environment. Here&apos;s what
              you can expect as part of our team:
            </p>
            {/* Image Snippets */}
            <div className="pt-4">
              <ImageSnippets
