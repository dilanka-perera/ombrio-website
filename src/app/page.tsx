      ...
      <div className="py-8">
          ...
          content={
            <>
              <p>
                ...
                business. From machine learning models to intelligent
                automation, we deliver custom AI-driven solutions that optimize
                your processes, improve decision-making, and create new growth
                opportunities:
              </p>
              <ul className="list-disc pl-6 mt-4 space-y-2">
                ...
                <li>
                  <strong>Data Analytics & Insights:</strong> Extracting
                  valuable insights from your data to drive strategic decisions.
                </li>
                <li>
          ...
          content={
            <>
              <p>
                ...
                secure, and user-friendly websites that scale with your
                business:
              </p>
              <ul className="list-disc pl-6 mt-4 space-y-2">
                <li>
        ...
        <TwoHalves
          ...
          content={
            <>
              <p>
                As the demand for faster and more reliable wireless
                communication continues to grow, we are at the forefront of
                research and innovation in wireless technology. We are dedicated
                to exploring the latest advancements in 5G, IoT, and beyond to
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2">
                ...
                <li>
                  <strong>IoT Solutions:</strong> Developing wireless solutions
                  to connect devices and optimize data exchange in industries
                  like healthcare, smart cities, and manufacturing.
                </li>
                <li>
                ...
                <li>
                  <strong>Emerging Technologies:</strong> Investigating the
                  future of wireless communication technologies, including 6G,
                  dynamic spectrum access, and edge computing.
                </li>
              </ul>
            </>
          }
